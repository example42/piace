...
// package's test package. internal/puppetdb/adapter_test.go already
// established the convention of a minimal local copy for exactly this
// reason; this is that same convention applied here.
