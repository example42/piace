...
// this package's test package. internal/puppetdb/adapter_test.go and
// internal/compiler/testfixture_test.go already established the
...
// newResolver builds a *transport.Client and *CompilerContentResolver
// pointed at srv using fixture's certificates.
func newResolver(t *testing.T, fixture *tlsFixture, srv *httptest.Server) *CompilerContentResolver {
	t.Helper()
	...
	return NewCompilerContentResolver(client, ep.URL)
}
